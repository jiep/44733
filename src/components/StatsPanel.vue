  ...
  <div v-if="visible" class="max-w-full mx-4">
    <div class="sm:flex sm:space-x-4">
      <div
        ...
        overflow-hidden border border-yellow-500 border-t-4 
        border-t-yellow-500 transform transition-all w-full 
        sm:w-1/3 sm:my-8"
      >
        <div class="bg-white p-2">
          <div
            class="flex flex-col items-center sm:items-start 
            place-content-center sm:mt-0 sm:ml-2 sm:text-left"
          >
            ...
            <p v-if="!isLoading" class="text-center flex text-3xl font-bold text-yellow-700">
              {{ lottery_number.toString().padStart(5, '0') }}
            </p>
            <LoadingCircle v-else :isLoading="isLoading" />
          </div>
        </div>
      </div>
      <div
